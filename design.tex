...
\begin{figure}[]
\centering
	\includegraphics[scale=0.5]{delay_cost_per_urgency.eps}
 ...
 \Begin{
  ...
  \For{approach in approaches}{
  	\If{approach signal is red} {
		add cost of delay for all vehicles queued on approach to delayCost \;
	} 
	\Else{
		add cost of stopping and cost of minimum delay for all vehicles on approach to stoppingCost \;
	}
  }
